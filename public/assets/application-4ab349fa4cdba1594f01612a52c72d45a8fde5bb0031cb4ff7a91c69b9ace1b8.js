...
(function() {
  (function($) {
    ...
    $.fn.barcode = function(config) {
      ...
      default_messages = {
        ...
        decoderPath: "/assets/DecoderWorker-a51364512ac8b9e29710d1f557bdd21e46fdc4bed906668aa0fcf99bc2a9ac9b.js",
  ...
  jQuery(function($) {
    var barcode, container, inputArea, result;
    container = $("#container");
    ...
    barcode.on("decoding", function(e, o) {
      return inputArea.val(o.result.replace(/^[^:]+: /g, ""));
    });
